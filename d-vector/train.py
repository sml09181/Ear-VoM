...
def train(
    ...
    # ignore FutureWarning with `torch.load`
    ...
    for step in count(start=1):
        ...
        if step % valid_every == 0:
            ...
            print(f"Valid: step={step}, loss={avg_valid_loss:.1f}")
...
if __name__ == "__main__":
    ...
    PARSER.add_argument("-n", "--n_speakers", type=int, default=64) # 50
    PARSER.add_argument("-m", "--n_utterances", type=int, default=10) # 2000
    ...
    PARSER.add_argument("--decay_every", type=int, default=100000) # 50000
